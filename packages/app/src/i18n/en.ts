...
export const dict = {
  ...
  "home.push.install.status.expired": "This pairing request expired. Prepare a secure installer command to continue.",
  "home.push.install.status.failed": "Pairing failed. Prepare a secure installer command to try again.",
  ...
  "voice.editLangInSettings": "Edit lang in settings",
